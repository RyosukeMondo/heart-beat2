...
- [x] 1.1 Create scheduler module structure
...
- [x] 1.2 Implement SessionExecutor::start
...
- [x] 1.3 Integrate HR data stream
  - File: `rust/src/scheduler/executor.rs`
...
- [x] 1.5 Implement cron scheduling
  - File: `rust/src/scheduler/executor.rs`
...
- [x] 1.6 Export scheduler in lib.rs
