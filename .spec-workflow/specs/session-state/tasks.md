...
- [ ] 1.1 Create session.rs with state machine scaffold
...
- [ ] 1.2 Implement session lifecycle transitions
  - File: `rust/src/state/session.rs`
...
- [ ] 1.3 Add zone deviation detection
  - File: `rust/src/state/session.rs`
...
- [ ] 1.4 Add progress query methods
  - File: `rust/src/state/session.rs`
...
- [ ] 1.5 Export session in state/mod.rs
