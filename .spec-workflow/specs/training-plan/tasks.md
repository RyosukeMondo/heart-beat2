...
- [x] 1.1 Create training_plan.rs with data structures
...
- [x] 1.2 Implement zone calculation function
  - File: `rust/src/domain/training_plan.rs`
...
- [x] 1.4 Create example training plans
...
- [x] 1.5 Export training_plan in domain/mod.rs
