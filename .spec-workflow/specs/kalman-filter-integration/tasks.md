...
- [x] 1. Wire KalmanFilter into connect_device HR pipeline
...
- [x] 2. Add filter state management to HR stream task
  - File: rust/src/api.rs
...
- [x] 3. Update FilteredHeartRate to include filter confidence
...
- [x] 5. Add Kalman filter integration tests
...
- [x] 6. Tune filter parameters for Coospo HW9
