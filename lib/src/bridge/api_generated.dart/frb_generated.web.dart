...
abstract class RustLibApiImplPlatform extends BaseApiImpl<RustLibWire> {
  ...
  @protected
  String cst_encode_StreamSink_api_cue_Dco(RustStreamSink<ApiCue> raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return cst_encode_String(
      raw.setupAndSerialize(
        codec: DcoCodec(
  ...
  @protected
  JSAny cst_encode_api_cue(ApiCue raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return [
      cst_encode_String(raw.id),
      cst_encode_u_8(raw.source),
      cst_encode_String(raw.label),
      cst_encode_String(raw.message),
      cst_encode_u_8(raw.priority),
      cst_encode_u_64(raw.generatedAtMillis),
    ].jsify()!;
  }
  ...
  @protected
  JSAny cst_encode_box_autoadd_api_cue(ApiCue raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return cst_encode_api_cue(raw);
  }
...
class RustLibWire implements BaseWire {
  ...
  void wire__crate__api__create_coaching_cue_stream(
    NativePortType port_,
    String sink,
  ) => wasmModule.wire__crate__api__create_coaching_cue_stream(port_, sink);
  ...
  void wire__crate__api__emit_coaching_cue(NativePortType port_, JSAny cue) =>
      wasmModule.wire__crate__api__emit_coaching_cue(port_, cue);
  ...
  void wire__crate__api__init_coaching_engine(NativePortType port_) =>
      wasmModule.wire__crate__api__init_coaching_engine(port_);
  ...
  void wire__crate__api__start_debug_server(NativePortType port_, int port) =>
      wasmModule.wire__crate__api__start_debug_server(port_, port);
...
extension type RustLibWasmModule._(JSObject _) implements JSObject {
  ...
  external void wire__crate__api__create_coaching_cue_stream(
    NativePortType port_,
    String sink,
  );
  ...
  external void wire__crate__api__emit_coaching_cue(
    NativePortType port_,
    JSAny cue,
  );
  ...
  external void wire__crate__api__init_coaching_engine(NativePortType port_);
  ...
  external void wire__crate__api__start_debug_server(
    NativePortType port_,
    int port,
  );
