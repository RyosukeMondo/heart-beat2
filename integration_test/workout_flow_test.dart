...
void main() {
  patrolTest('Start workout flow - tap Start Workout and select plan', (
    $,
  ) async {
  ...
  patrolTest('Start workout flow - verify plan selector can be dismissed', (
    $,
  ) async {
    // Perform full device connection to reach session screen
    await performDeviceConnection($);
  ...
  patrolTest('Start workout flow - multiple plans visible in selector', (
    $,
  ) async {
  ...
  patrolTest('Start workout flow - plan selector shows loading state', (
    $,
  ) async {
    // Perform full device connection
    await performDeviceConnection($);
  ...
  patrolTest('Start workout flow - verify workout screen starts workout', (
    $,
  ) async {
    ...
    expect(loadingExists || find.byType(AppBar).evaluate().isNotEmpty, isTrue);
  });

  patrolTest('Start workout flow - back navigation from workout to session', (
    $,
  ) async {
  ...
  patrolTest('Regression test - PlanSelector navigation bug is fixed', (
    $,
  ) async {
