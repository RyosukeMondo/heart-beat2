...
void main() {
  patrolTest('Navigate to history screen from home', ($) async {
    // Launch the app
    await launchApp($);
  ...
  patrolTest('History screen shows empty state when no sessions exist', (
    $,
  ) async {
  ...
  patrolTest('Pull to refresh on history screen', ($) async {
    // Launch the app and navigate to history
    await launchApp($);
    await $(Icons.history).tap();
    await $.pumpAndSettle();
  ...
  patrolTest('Navigate back from history to home', ($) async {
  ...
  patrolTest('History screen shows session list when sessions exist', (
    $,
  ) async {
  ...
  patrolTest('Tap session opens detail screen', ($) async {
    // Launch and navigate to history
    await launchApp($);
    await $(Icons.history).tap();
    await $.pumpAndSettle();
  ...
  patrolTest('Navigate back from session detail to history', ($) async {
    // Launch and navigate to history
    await launchApp($);
    await $(Icons.history).tap();
    await $.pumpAndSettle();
  ...
  patrolTest('Session detail shows error for invalid session', ($) async {
    // Launch app
    await launchApp($);
  ...
  patrolTest('Long press session enables selection mode', ($) async {
    // Launch and navigate to history
    await launchApp($);
    await $(Icons.history).tap();
    await $.pumpAndSettle();
  ...
  patrolTest('Exit selection mode with close button', ($) async {
    // Launch and navigate to history
    await launchApp($);
    await $(Icons.history).tap();
    await $.pumpAndSettle();
  ...
  patrolTest('Complete history navigation flow', ($) async {
