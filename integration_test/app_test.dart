...
void main() {
  patrolTest('Heart Beat E2E flow: scan, connect, verify HR stream', ($) async {
    // Launch the app
    await app.main();
    await $.pumpAndSettle();
  ...
  patrolTest('Settings: max heart rate persistence', ($) async {
    // Launch the app
    await app.main();
    await $.pumpAndSettle();
  ...
  patrolTest('Permission denial handling', ($) async {
    // Launch the app
    await app.main();
    await $.pumpAndSettle();
