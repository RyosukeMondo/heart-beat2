...
void main() {
  patrolTest('Navigate to settings and verify screen elements', ($) async {
    // Launch the app
    await launchApp($);
  ...
  patrolTest('Modify max HR and save successfully', ($) async {
  ...
  patrolTest('Enable age-based max HR calculation', ($) async {
    // Clear any existing profile data
    SharedPreferences.setMockInitialValues({});
    final prefs = await SharedPreferences.getInstance();
    await prefs.clear();
  ...
  patrolTest('Modify age and verify age-based max HR updates', ($) async {
    // Clear any existing profile data
    SharedPreferences.setMockInitialValues({});
    final prefs = await SharedPreferences.getInstance();
    await prefs.clear();
  ...
  patrolTest('Audio feedback settings modification', ($) async {
    // Clear any existing profile data
    SharedPreferences.setMockInitialValues({});
    final prefs = await SharedPreferences.getInstance();
    await prefs.clear();
  ...
  patrolTest('Settings persist across app restart', ($) async {
    // Clear any existing profile data
    SharedPreferences.setMockInitialValues({});
    final prefs = await SharedPreferences.getInstance();
    await prefs.clear();
  ...
  patrolTest('Validation error for invalid max HR', ($) async {
    // Clear any existing profile data
    SharedPreferences.setMockInitialValues({});
    final prefs = await SharedPreferences.getInstance();
    await prefs.clear();
  ...
  patrolTest('Validation error for invalid age', ($) async {
    // Clear any existing profile data
    SharedPreferences.setMockInitialValues({});
    final prefs = await SharedPreferences.getInstance();
    await prefs.clear();
  ...
  patrolTest('Age-based switch disabled without age input', ($) async {
    // Clear any existing profile data
    SharedPreferences.setMockInitialValues({});
    final prefs = await SharedPreferences.getInstance();
    await prefs.clear();
  ...
  patrolTest('Max HR field disabled when using age-based calculation', (
    $,
  ) async {
    // Clear any existing profile data
    SharedPreferences.setMockInitialValues({});
    ...
    expect(find.text('Using age-based calculation'), findsOneWidget);
  });

  patrolTest('Navigate back from settings without saving', ($) async {
    // Launch and navigate to settings
    await launchApp($);
    await navigateToSettings($);
  ...
  patrolTest('Complete settings modification flow', ($) async {
    // Clear any existing profile data
    SharedPreferences.setMockInitialValues({});
    final prefs = await SharedPreferences.getInstance();
    await prefs.clear();
