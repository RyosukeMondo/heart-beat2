...
void main() {
  patrolTest('Successful device connection flow', ($) async {
    // Launch the app
    await launchApp($);
  ...
  patrolTest('Permission denial handling during connection', ($) async {
    // Launch the app
    await launchApp($);
  ...
  patrolTest('Scan button state changes during scanning', ($) async {
    // Launch the app
    await launchApp($);
  ...
  patrolTest('Multiple device scan results', ($) async {
    // Launch the app
    await launchApp($);
  ...
  patrolTest('Connection to device navigates to session screen', ($) async {
    // Launch the app
    await launchApp($);
  ...
  patrolTest('Session screen displays after successful connection', ($) async {
  ...
  patrolTest('Back navigation from session screen to home', ($) async {
    // Perform full connection flow
    await performDeviceConnection($);
  ...
  patrolTest('Re-scan after permission denial', ($) async {
    // Launch app
    await launchApp($);
  ...
  patrolTest('Device list cleared on new scan', ($) async {
    // Launch app
    await launchApp($);
  ...
  patrolTest('Connection flow using high-level helper', ($) async {
